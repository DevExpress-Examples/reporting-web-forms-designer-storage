...
namespace SimpleWebReportCatalog.CatalogDataTableAdapters {
    ...
    public partial class ReportsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Reports` (`DisplayName`, `LayoutData`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Reports` SET `DisplayName` = ?, `LayoutData` = ? WHERE ((`ReportID` = ?))" +
                "";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ReportID, DisplayName, LayoutData FROM Reports";
