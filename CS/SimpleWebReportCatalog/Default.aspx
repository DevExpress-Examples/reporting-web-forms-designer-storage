<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SimpleWebReportCatalog.Default" %>
    ...
    <form id="CatalogForm" runat="server">
        ...
        <div>
            <asp:ListBox ID="ReportsList" runat="server" Width="600px"
                ...
                DataValueField="ReportID" Height="150px"></asp:ListBox>
            <asp:AccessDataSource ID="AccessDataSource1" runat="server"
                DataFile="~/App_Data/catalog.mdb" SelectCommand="SELECT * FROM [Reports]"></asp:AccessDataSource>
        </div>
        <div>
