...
Namespace SimpleWebReportCatalog
    ...
    Public Partial Class [Default]
        ...
        Protected Sub NewReportButton_Click(ByVal sender As Object, ByVal e As EventArgs)
            MyBase.Session("DesignerTask") = New DesignerTask With {.mode = ReportEdditingMode.NewReport}
        ...
        Protected Sub EditButton_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            If selected IsNot Nothing Then
                MyBase.Session("DesignerTask") = New DesignerTask With {.mode = ReportEdditingMode.ModifyReport, .reportID = selected.Value}
                MyBase.Session("ReportID") = selected.Value
                Response.Redirect("Designer.aspx")
            End If
        End Sub
